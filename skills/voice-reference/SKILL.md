...
description: "Twilio development skill: voice-reference"
---

<!-- ABOUTME: Detailed reference material for TwiML verbs, patterns, and conference APIs. -->
<!-- ABOUTME: Contains code examples, options tables, and advanced call control patterns. -->

# Voice Reference

For essential context, file inventory, and gotchas, see [CLAUDE.md](./CLAUDE.md).
