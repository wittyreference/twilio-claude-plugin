---
name: "sync-reference"
description: "Twilio development skill: sync-reference"
---
...
<!-- verified: live-tested 2026-03-25. See skills/sync/references/error-codes.md for full evidence. -->

| Code | HTTP | Description |
|------|------|-------------|
| `20404` | 404 | Resource not found (documents, lists, maps, items — all use this generic code) |
| `54006` | 413 | Request entity too large (data >16KB, or Stream message >4KB) |
| `54008` | 400 | Invalid request body / invalid JSON in Data parameter |
| `54103` | 412 | Revision mismatch on conditional update (If-Match header) |
| `54208` | 409 | Map item key already exists (add is not upsert) |
| `54301` | 409 | Unique name already exists |
