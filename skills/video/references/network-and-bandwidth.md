...
<!-- ABOUTME: Network quality and bandwidth optimization for Twilio Video rooms. -->
<!-- ABOUTME: Covers simulcast, bandwidth profiles, Network Quality API, preflight checks, and capture constraints. -->
