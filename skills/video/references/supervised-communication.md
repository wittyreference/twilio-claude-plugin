...
<!-- ABOUTME: Supervised communication patterns — invisible observers, proctoring, Track Subscriptions API. -->
<!-- ABOUTME: Covers true observer pattern, visibility levels, prison visitation example, and subscribe rules gotchas. -->
