...
<!-- ABOUTME: Client-side SDK integration patterns for Twilio Video (JavaScript, iOS, Android). -->
<!-- ABOUTME: Covers connection, track management, screen share, DataTrack API, and platform differences. -->
