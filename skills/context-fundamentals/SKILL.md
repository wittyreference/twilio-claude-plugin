...
description: Context engineering principles for Twilio development. Use when optimizing context window usage or managing conversation memory.
---
...
This skill is adapted from [Agent Skills for Context Engineering](https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering) by Murat Can Koylan, which provides foundational patterns for context management in AI-assisted development. The original work has been modified for Twilio-specific use cases.
...
|----------------|------|--------------|
| Skill files | ~500 lines each | High - project standards |
...
- Loading multiple skill files simultaneously
