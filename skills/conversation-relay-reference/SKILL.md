---
name: "conversation-relay-reference"
description: "Twilio development skill: conversation-relay-reference"
---

<!-- ABOUTME: Complete reference for ConversationRelay patterns, LLM integration, and development setup. -->
<!-- ABOUTME: Companion to CLAUDE.md — contains code samples, configuration details, and integration guides. -->

# Conversation Relay Reference

For essential patterns and quick reference, see [CLAUDE.md](./CLAUDE.md).

## Full ConversationRelay Configuration
...
## WebSocket Message Protocol (Full Examples)
...
2. **Configure auth**: `ngrok config add-authtoken YOUR_AUTH_TOKEN`
3. **Start WebSocket server locally**: `node websocket-server.js` (port 8080)
4. **Expose with ngrok**: `ngrok http 8080`
5. **Use ngrok URL**: `wss://abc123.ngrok.io/relay`

### Stable Development URL

For consistent URL, use a custom domain (requires paid ngrok):
...
## Conference Call Pattern (Full Code)
