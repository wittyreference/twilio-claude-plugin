...
description: "Twilio development skill: tool-boundaries"
---
...
- Phone number purchase/release ARE MCP tools (`purchase_phone_number`, `release_phone_number`) — confirm with user before executing (financial/irreversible)
- Account management tools exist (13 tools in P3 tier) — subaccount operations available via MCP
