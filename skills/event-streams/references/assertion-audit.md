...
| 10 | Cannot receive transcript content via Event Streams | Scope | QUALIFIED | Docs do not list transcript content events. Not live-tested because it requires specific Intelligence v3 setup. |
