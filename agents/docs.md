...
2. **Skill Files**: Maintain domain-specific skill documentation
...
1. Update root README architecture section
2. Update directory structure documentation
3. Review all skill files
...
- `skills/[domain].md` - Updated [section]
